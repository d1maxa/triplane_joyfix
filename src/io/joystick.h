...
void get_joystick_action(int t, int inmenu, int *down, int *up, int *power, int *roll, int *guns, int *bombs, int power_on_off, int power_reverse, unsigned char *controls_power2, int in_closing);
